...
export const matrixData: MatrixRow[] = [
  ...
  { model: 'R1-Distill-Llama-8B', hardware: 'RTX 4090 24G', framework: 'llama.cpp', quant: 'GGUF Q4_K_M', speedTokSec: 145, vramUsedGB: 5.6, notes: 'R1 reasoning on 8B footprint' },
  { model: 'Phi-4 14B', hardware: 'RTX 4090 24G', framework: 'llama.cpp', quant: 'GGUF Q4_K_M', speedTokSec: 88, vramUsedGB: 9.1, notes: 'Strong dense 14B; 12GB with short ctx' },
  { model: 'Qwen3-Coder 30B-A3B', hardware: 'RTX 4090 24G', framework: 'llama.cpp', quant: 'GGUF Q4_K_M', speedTokSec: 92, vramUsedGB: 19.2, notes: 'Agentic coding MoE; 256K native ctx' },
